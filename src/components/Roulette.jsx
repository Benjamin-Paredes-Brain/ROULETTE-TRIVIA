...
export const Roulette = () => {
    ...
    const stopSpinning = () => {
        ...
        setTimeout(() => {
            ...
            if (randomIndex === 0) {
                setTimeout(() => {
                    window.location.href = "/questions/trabajo-infantil";
                }, 2000);
            } else if (randomIndex === 1) {
                setTimeout(() => {
                    window.location.href = "/questions/seguridad-social";
                }, 2000);
            }

            else if (randomIndex === 2) {
                setTimeout(() => {
                    window.location.href = "/questions/historia-del-trabajo";
                }, 2000);
            }
        }, 100);
    };
    ...
    return (
        <div className="main_card">
            <h2 className="roulette_title">TRIVIA FVT</h2>
